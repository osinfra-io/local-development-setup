...
() {
  ...
  # POKUBECONTEXT_DEFAULT_VISUAL_IDENTIFIER_EXPANSIONWERLEVEL9K_ASDF_SOURCES will hide python version only if the value of this parameter doesn't
  # contain "local".
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|istioctl|kubectx|kubens|k9s'
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_PRE_PROD_FOREGROUND=003
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      ...
      '*-prod*'  PROD
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND=002
  # typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_VISUAL_IDENTIFIER_EXPANSION='⎈'
  typeset -g POWERLEVEL9K_KUBECONTEXT_VISUAL_IDENTIFIER_COLOR=004
